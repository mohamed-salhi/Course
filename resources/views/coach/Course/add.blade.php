        ...
        <div class="page-content-wrapper">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="well form-horizontal" action="{{route('Course.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-xl-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input style="text-transform: capitalize;" placeholder="Enter Course Detail"
                                                       name="detail" id="detail" type="text" class="form-control">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input style="text-transform: capitalize;" placeholder="Enter Course Detail"
                                                       name="price" id="detail" type="number" class="form-control">
